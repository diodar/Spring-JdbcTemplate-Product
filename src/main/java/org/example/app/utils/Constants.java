...
public final class Constants {
    ...
    public final static String PRICE_ERR_MSG = "Incorrect price.";
    public final static String QUOTA_ERR_MSG = "Incorrect quota.";
    ...
    public final static String INCORRECT_VALUE_MSG = "\n>> Incorrect value! Try again...";
